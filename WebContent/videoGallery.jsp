...
<!-- Title -->
<title>Perfekt Pillows - Video Gallery</title>
...
<body>
	...
	<section class="breadcumb-area bg-img bg-overlay"
		style="background-image: url(img/bg-img/posters/posterVideo.jpg);">
...
<div class="row">
  ...
  <div class="col-lg-4 col-md-12 mb-4">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body mb-0 p-0">
            ...
            <div class="embed-responsive embed-responsive-16by9 z-depth-1-half">
              <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/sHsSJNLUQ7s"
    ...
    <a><img class="img-fluid z-depth-1" src="http://i3.ytimg.com/vi/sHsSJNLUQ7s/maxresdefault.jpg" alt="video"
						...
						<div class="modal-content">
							...
							<div class="modal-body mb-0 p-0">
								...
								<div
									class="embed-responsive embed-responsive-16by9 z-depth-1-half">
									<iframe class="embed-responsive-item"
										src="https://www.youtube.com/embed/pqKZ2sTd6M0"
										allowfullscreen></iframe>
								</div>
