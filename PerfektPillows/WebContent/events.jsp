...
<meta name="author" content="Saurabh Sharma">
    <!-- Title -->
    <title>PerfeKt Pillows - Events</title>
...
<%@include file="header.jsp"%>
    ...
    <section class="breadcumb-area bg-img bg-overlay" style="background-image: url(img/bg-img/posters/eventPoster.jpg);">
                    ...
                    <div class="blog-sidebar-area">
                        ...
                        <div class="single-widget-area mb-30">
                            <div class="widget-title">
                                ...
                                <!-- LightWidget WIDGET --><script src="https://cdn.lightwidget.com/widgets/lightwidget.js"></script><iframe src="//lightwidget.com/widgets/71618e0064f958c3b4c25f520dbfd102.html" scrolling="no" allowtransparency="true" class="lightwidget-widget" style="width:100%;border:0;overflow:hidden;"></iframe>
