...
<body>
   ...
   <%@include file="header.jsp"%>
    ...
    <section class="breadcumb-area bg-img bg-overlay" style="background-image: url(img/bg-img/posters/contactBanner.jpg);">
 ...
 -->
	...
	<section
		...
		style="background-image: url(img/bg-img/posters/bgPoster.jpg);">
	<div class="container">
		<div class="row">
			<div class="col-12">
